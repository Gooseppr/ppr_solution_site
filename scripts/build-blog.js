...
<head>
  ...
  <script>
    (function () {
      try {
        var stored = localStorage.getItem("ppr-theme");
...
<body>
  ...
  <header class="navbar">
    <div class="container nav-inner">
      ...
      <button class="theme-toggle" type="button" data-theme-toggle aria-pressed="false" aria-label="Activer le thème sombre">
