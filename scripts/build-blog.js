...
function renderBlog(posts) {
  ...
  const blogSchema = { "@context": "https://schema.org", "@type": "CollectionPage", name: "Bibliothèque XML PPR-Solution", url: `${BASE_URL}/blog.html`, mainEntity: { "@type": "ItemList", itemListElement: sorted.map((post, index) => ({ "@type": "ListItem", position: index + 1, url: `${BASE_URL}/blog/${post.slug}/`, name: post.title })) } };
